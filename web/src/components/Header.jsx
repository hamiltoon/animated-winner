    ...
    <header>
      <div className="container header-content">
        <div className="header-text">
          ...
          <p className="subtitle">Delicious recipes saved from across the web</p>
        </div>
        <div className="auth-section">
          {!user ? (
            ...
            <DropdownMenu.Root>
              <DropdownMenu.Trigger className="user-profile">
              ...
              <DropdownMenu.Portal>
                <DropdownMenu.Content className="dropdown-content" sideOffset={5}>
                  <DropdownMenu.Item className="dropdown-item" onSelect={onSignOut}>
                    Sign Out
                  </DropdownMenu.Item>
